...
namespace LocationsSearchWebServiceClient
{
    class Program
    {
        ...
        private static void SetConstraints(SearchLocationsRequest request)
        {
            ...
            request.Constraints.RadiusDistance.Value = new Decimal(15.0);
            ...
            //
            request.Constraints.RequiredLocationAttributes = new LocationAttributesType[1];
            request.Constraints.RequiredLocationAttributes[0] = LocationAttributesType.ALREADY_OPEN;
            //
            request.Constraints.ResultsRequested = "1";
            //
